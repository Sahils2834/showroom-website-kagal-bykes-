            ...
            <div>
              ...
              <div className="space-y-4 font-light text-gray-400 text-sm">
                <p className="flex items-start gap-3">
                  ...
                  <span>JAISINGH RAO PARK, Main Road,<br />Kagal, Maharashtra 416216</span>
                </p>
                ...
                <p className="flex items-center gap-3">
                  <span className="text-hero-red">&#8226;</span>
                  <a href="mailto:savitashte85@gmail.com" className="hover:text-white transition">savitashete85@gmail.com</a>
                </p>
                <p className="flex items-center gap-3">
                  <span className="text-hero-red">&#8226;</span>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-hero-dark border border-white/10 rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden animate-in">
            ...
            <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs">JAISINGH RAO PARK, Main Road, Kagal, Maharashtra 416216</p>
                </div>
              </div>
              <button
                onClick={() => setShowMap(false)}
            ...
            <div className="w-full h-[400px]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3823.730743114579!2d74.30864919999999!3d16.5900555!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc0ffddbf75b7bd%3A0xeaec3e984843ad8e!2sM%2FS.%20Kagal%20Bykes%20-%20Hero%20MotoCorp!5e0!3m2!1sen!2sin!4v1773767469576!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen=""
